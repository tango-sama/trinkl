function Footer({ isAdmin }) {
    ...
    return (
        <footer className="bg-[#fbeeea] text-[var(--text-dark)] mt-20 relative overflow-hidden border-t border-[var(--border-color)]">
            {/* Decorative elements */}
            ...
            <div className="container mx-auto px-4 py-16 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                            <a href="#" className="w-10 h-10 rounded-full bg-[var(--primary)]/10 flex items-center justify-center hover:bg-[var(--primary)] transition-all hover:scale-110">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
                            </a>
                            <a href="https://www.facebook.com/share/1KbucDXk34/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-[var(--primary)]/10 flex items-center justify-center hover:bg-[var(--primary)] transition-all hover:scale-110">
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="text-lg font-bold mb-4 text-[var(--text-dark)]">روابط سريعة</h3>
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={link.to}>
                                    <ReactRouterDOM.Link 
                                        to={link.to} 
                                        className="text-[var(--text-muted)] hover:text-[var(--secondary)] transition-colors flex items-center gap-2 group"
                                    >
                                        <span className="w-1.5 h-1.5 rounded-full bg-[var(--primary)] opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                        {link.label}
                                    </ReactRouterDOM.Link>
                                </li>
                            ))}
                    ...
                    {/* Categories */}
                    <div>
                        <h3 className="text-lg font-bold mb-4 text-[var(--text-dark)]">التصنيفات</h3>
                        <ul className="space-y-3">
                    ...
                    {/* Contact */}
                    <div>
                        <h3 className="text-lg font-bold mb-4 text-[var(--text-dark)]">تواصل معنا</h3>
